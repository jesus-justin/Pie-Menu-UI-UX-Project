        ...
        <section class="auth-card">
            ...
            <form method="post" class="form-grid" novalidate aria-labelledby="login-heading">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="username" name="username" value="<?php echo e($username); ?>" autocomplete="username" pattern="[A-Za-z0-9_]{3,32}" minlength="3" maxlength="32" aria-describedby="username-hint" aria-required="true" placeholder="Enter your username" required />
                    <span id="username-hint" class="helper" style="display:none;">3-32 characters: letters, numbers, underscore</span>
                </div>
                <div class="form-group">
                    <label for="password">Password</label>
                    <div style="position:relative;">
                        <input class="form-control" type="password" id="password" name="password" autocomplete="current-password" minlength="8" aria-required="true" placeholder="Enter your password" required />
